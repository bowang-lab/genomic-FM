...
from .olmo_utils.torch_util import barrier, get_fs_local_rank, get_global_rank, get_world_size
from .olmo_utils.util import roundrobin, threaded_generator

__all__ = ["EffIterableDataset"]

log = logging.getLogger(__name__)


class EffIterableDataset(torch.utils.data.IterableDataset[Dict[str, Any]]):
    """
